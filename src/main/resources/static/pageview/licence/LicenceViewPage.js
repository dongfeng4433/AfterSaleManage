var vm = new Vue({
    ...
    methods: {
        ...
        getDataList: function (judge) {
            var _vue = this;
            var url = js.Web.GenerateUrl("Licence", "searchLicence");
        ...
        ok: function () {
            ...
            url=js.Web.GenerateUrl("Licence", "saveLicence");
        ...
        okImport: function () {
            ...
            url=js.Web.GenerateUrl("Licence", "importLicence");
        ...
        deleteLicence:function(row){
            ...
            url=js.Web.GenerateUrl("Licence", "deleteLicence");
            if(!params.xkz_xh) {
