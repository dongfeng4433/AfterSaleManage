...
public class LicenceController extends BaseController {
    ...
    public ResponseEntity<ResultListModel> searchLicence(HttpServletRequest servletRequest, HttpServletResponse httpServletResponse, PagingOptions pagingOptions, TYwXkzQueryModel queryModel) throws Exception {
        ...
        if (sessionModel.isLogin() == false){
            ...
            List<TYwXkzDtoModel>  dtoModelList= dataService.selectT_YW_XKZ(pagingOptions, queryModel,null);
            for(TYwXkzDtoModel dtoModel:dtoModelList){
    ...
    public ResponseEntity<BaseResultModel> saveLicence(HttpServletRequest servletRequest, HttpServletResponse httpServletResponse,TYwXkzDtoModel model) throws Exception {
    ...
    public ResponseEntity<BaseResultModel> importLicence(HttpServletRequest servletRequest, HttpServletResponse httpServletResponse,TYwXkzDtoModel model) throws Exception {
        BaseResultModel baseResultModel = new BaseResultModel();
        String loginId = "";
        SessionModel sessionModel = ChkLogin(servletRequest);
        if (sessionModel.isLogin() == false){
