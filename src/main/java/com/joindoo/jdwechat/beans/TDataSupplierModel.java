...
public class TDataSupplierModel extends BaseModel implements IBaseModel{
	 public static final String TABLE_NAME="T_DATA_SUPPLIER";
	 public static final String SCRIPT_INSERT="INSERT INTO t_data_supplier(supplier_id,enterprise_id,name,short_name,address,type_code,description,telephone_number,is_valid,create_time,last_edit_time,creation_user_id,last_edit_user_id)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)";
	 public static final String SCRIPT_DELETE="DELETE FROM t_data_supplier WHERE  supplier_id=? ";
	 public static final String SCRIPT_UPDATE="UPDATE t_data_supplier  SET {0} WHERE  supplier_id=? ";
	 public static final String SCRIPT_SELECT="SELECT supplier_id,enterprise_id,name,short_name,address,type_code,description,telephone_number,is_valid,create_time,last_edit_time,creation_user_id,last_edit_user_id FROM t_data_supplier WHERE (1=1)";
	...
	public void setsupplier_id(String value){
		this.supplier_id=value;
 		this.onChangeProperty("supplier_id",this.supplier_id,value);
 	}
	...
	public void settype_code(String value){
		this.type_code=value;
 		this.onChangeProperty("type_code",this.type_code,value);
 	}
	...
	public TDataSupplierModel(){
		super();
		this._keyProperty.add("supplier_id");
		initFieldsType();
	}

	private void initFieldsType(){
		this._fieldType.put("supplier_id","String");
		...
		this._fieldType.put("type_code","String");
	...
	public void fillModel(ResultSet resultSet) {
		try { 
		 if(isExistColumn(resultSet,"supplier_id")){
			 this.supplier_id=resultSet.getString("supplier_id");
		}
		 ...
		 if(isExistColumn(resultSet,"type_code")){
			 this.type_code=resultSet.getString("type_code");
		}
  ...
  @Override
   public String getExist() {
	    String sql="select 1 from "+TABLE_NAME;
		    sql+=" where   supplier_id="+Utility.getSqlFielStatement("string",this.supplier_id)+"  ";
	    return sql;
   }
   ...
   public String getInsert() {
       String sql="insert into "+TABLE_NAME+"(supplier_id,enterprise_id,name,short_name,address,type_code,description,telephone_number,is_valid,create_time,last_edit_time,creation_user_id,last_edit_user_id) values("+Utility.getSqlFielStatement("string",this.supplier_id)+","+Utility.getSqlFielStatement("string",this.enterprise_id)+","+Utility.getSqlFielStatement("string",this.name)+","+Utility.getSqlFielStatement("string",this.short_name)+","+Utility.getSqlFielStatement("string",this.address)+","+Utility.getSqlFielStatement("string",this.type_code)+","+Utility.getSqlFielStatement("string",this.description)+","+Utility.getSqlFielStatement("string",this.telephone_number)+","+this.is_valid+","+Utility.getSqlFielStatement("date",this.create_time)+","+Utility.getSqlFielStatement("date",this.last_edit_time)+","+Utility.getSqlFielStatement("string",this.creation_user_id)+","+Utility.getSqlFielStatement("string",this.last_edit_user_id)+")";
       return sql;
   }
   ...
   return sql;
	...
	public String getSelect() {
		String sql="select supplier_id,enterprise_id,name,short_name,address,type_code,description,telephone_number,is_valid,create_time,last_edit_time,creation_user_id,last_edit_user_id from "+TABLE_NAME;
		if(!Utility.isNullOrEmpty(supplier_id)){
			sql+=" where  supplier_id="+Utility.getSqlFielStatement("string",this.supplier_id)+" ";
		}
		return sql;
	}
   ...
   public String getDelete() {
	 String sql="delete from "+TABLE_NAME+" where  supplier_id="+Utility.getSqlFielStatement("string",this.supplier_id)+" ";
	 return sql;
   }
