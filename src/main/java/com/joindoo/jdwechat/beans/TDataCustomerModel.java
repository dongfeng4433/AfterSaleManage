...
public class TDataCustomerModel extends BaseModel implements IBaseModel{
	 public static final String TABLE_NAME="T_DATA_CUSTOMER";
	 public static final String SCRIPT_INSERT="INSERT INTO t_data_customer(customer_id,enterprise_id,name,short_name,address,type_code,description,telephone_number,is_valid,create_time,last_edit_time,creation_user_id,last_edit_user_id)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)";
	 public static final String SCRIPT_DELETE="DELETE FROM t_data_customer WHERE  customer_id=? ";
	 public static final String SCRIPT_UPDATE="UPDATE t_data_customer  SET {0} WHERE  customer_id=? ";
	 public static final String SCRIPT_SELECT="SELECT customer_id,enterprise_id,name,short_name,address,type_code,description,telephone_number,is_valid,create_time,last_edit_time,creation_user_id,last_edit_user_id FROM t_data_customer WHERE (1=1)";
  ...
  @Override
   public String getExist() {
	    String sql="select 1 from "+TABLE_NAME;
		    sql+=" where   customer_id="+Utility.getSqlFielStatement("string",this.customer_id)+"  ";
	    return sql;
   }
   ...
   public String getInsert() {
       String sql="insert into "+TABLE_NAME+"(customer_id,enterprise_id,name,short_name,address,type_code,description,telephone_number,is_valid,create_time,last_edit_time,creation_user_id,last_edit_user_id) values("+Utility.getSqlFielStatement("string",this.customer_id)+","+Utility.getSqlFielStatement("string",this.enterprise_id)+","+Utility.getSqlFielStatement("string",this.name)+","+Utility.getSqlFielStatement("string",this.short_name)+","+Utility.getSqlFielStatement("string",this.address)+","+Utility.getSqlFielStatement("string",this.type_code)+","+Utility.getSqlFielStatement("string",this.description)+","+Utility.getSqlFielStatement("string",this.telephone_number)+","+this.is_valid+","+Utility.getSqlFielStatement("date",this.create_time)+","+Utility.getSqlFielStatement("date",this.last_edit_time)+","+Utility.getSqlFielStatement("string",this.creation_user_id)+","+Utility.getSqlFielStatement("string",this.last_edit_user_id)+")";
       return sql;
   }
   ...
   return sql;
	...
	public String getSelect() {
		String sql="select customer_id,enterprise_id,name,short_name,address,type_code,description,telephone_number,is_valid,create_time,last_edit_time,creation_user_id,last_edit_user_id from "+TABLE_NAME;
		if(!Utility.isNullOrEmpty(customer_id)){
			sql+=" where  customer_id="+Utility.getSqlFielStatement("string",this.customer_id)+" ";
		}
		return sql;
	}
   ...
   public String getDelete() {
	 String sql="delete from "+TABLE_NAME+" where  customer_id="+Utility.getSqlFielStatement("string",this.customer_id)+" ";
	 return sql;
   }
