...
public class TXtQxRy2BmModel extends BaseModel implements IBaseModel{
	 public static final String TABLE_NAME="T_XT_QX_RY_2_BM";
	 public static final String SCRIPT_INSERT="INSERT INTO t_xt_qx_ry_2_bm(ry_xh,bm_dm,sfbm_gl,ms,lr_sj,xg_sj,lrry_xh,xgry_xh,sfyx_bj)VALUES(?,?,?,?,?,?,?,?,?)";
	 public static final String SCRIPT_DELETE="DELETE FROM t_xt_qx_ry_2_bm WHERE  ry_xh=? AND bm_dm=? ";
	 public static final String SCRIPT_UPDATE="UPDATE t_xt_qx_ry_2_bm  SET {0} WHERE  ry_xh=? AND bm_dm=? ";
	 public static final String SCRIPT_SELECT="SELECT ry_xh,bm_dm,sfbm_gl,ms,lr_sj,xg_sj,lrry_xh,xgry_xh,sfyx_bj FROM t_xt_qx_ry_2_bm WHERE (1=1)";
	...
	public void setsfbm_gl(Integer value){
		this.sfbm_gl=value;
 		this.onChangeProperty("sfbm_gl",this.sfbm_gl,value);
 	}
	...
	private void initFieldsType(){
		...
		this._fieldType.put("sfbm_gl","Integer");
	...
	public void fillModel(ResultSet resultSet) {
		try { 
		 ...
		 if(isExistColumn(resultSet,"sfbm_gl")){
			 this.sfbm_gl=resultSet.getInt("sfbm_gl");
		}
  ...
  @Override
   public String getExist() {
	    String sql="select 1 from "+TABLE_NAME;
		    sql+=" where   ry_xh="+Utility.getSqlFielStatement("string",this.ry_xh)+" and bm_dm="+Utility.getSqlFielStatement("string",this.bm_dm)+"  ";
	    return sql;
   }
   ...
   public String getInsert() {
       String sql="insert into "+TABLE_NAME+"(ry_xh,bm_dm,sfbm_gl,ms,lr_sj,xg_sj,lrry_xh,xgry_xh,sfyx_bj) values("+Utility.getSqlFielStatement("string",this.ry_xh)+","+Utility.getSqlFielStatement("string",this.bm_dm)+","+this.sfbm_gl+","+Utility.getSqlFielStatement("string",this.ms)+","+Utility.getSqlFielStatement("date",this.lr_sj)+","+Utility.getSqlFielStatement("date",this.xg_sj)+","+Utility.getSqlFielStatement("string",this.lrry_xh)+","+Utility.getSqlFielStatement("string",this.xgry_xh)+","+this.sfyx_bj+")";
       return sql;
   }
   ...
   return sql;
	...
	public String getSelect() {
		String sql="select ry_xh,bm_dm,sfbm_gl,ms,lr_sj,xg_sj,lrry_xh,xgry_xh,sfyx_bj from "+TABLE_NAME;
		if(!Utility.isNullOrEmpty(ry_xh)&&!Utility.isNullOrEmpty(bm_dm)){
			sql+=" where  ry_xh="+Utility.getSqlFielStatement("string",this.ry_xh)+" and bm_dm="+Utility.getSqlFielStatement("string",this.bm_dm)+" ";
		}
		return sql;
	}
   ...
   public String getDelete() {
	 String sql="delete from "+TABLE_NAME+" where  ry_xh="+Utility.getSqlFielStatement("string",this.ry_xh)+" and bm_dm="+Utility.getSqlFielStatement("string",this.bm_dm)+" ";
	 return sql;
   }
