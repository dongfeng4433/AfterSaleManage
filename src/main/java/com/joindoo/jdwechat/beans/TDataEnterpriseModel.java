...
public class TDataEnterpriseModel extends BaseModel implements IBaseModel{
	 public static final String TABLE_NAME="T_DATA_ENTERPRISE";
	 public static final String SCRIPT_INSERT="INSERT INTO t_data_enterprise(enterprise_id,name,short_name,address,description,telephone_number,is_valid,create_time,last_edit_time,creation_user_id,last_edit_user_id,dd_corp_id)VALUES(?,?,?,?,?,?,?,?,?,?,?,?)";
	 public static final String SCRIPT_DELETE="DELETE FROM t_data_enterprise WHERE  enterprise_id=? ";
	 public static final String SCRIPT_UPDATE="UPDATE t_data_enterprise  SET {0} WHERE  enterprise_id=? ";
	 public static final String SCRIPT_SELECT="SELECT enterprise_id,name,short_name,address,description,telephone_number,is_valid,create_time,last_edit_time,creation_user_id,last_edit_user_id,dd_corp_id FROM t_data_enterprise WHERE (1=1)";
	...
	/*钉钉中的企业id*/ 
	protected String dd_corp_id;
	public String getdd_corp_id (){ return dd_corp_id;}
	public void setdd_corp_id(String value){
		this.dd_corp_id=value;
 		this.onChangeProperty("dd_corp_id",this.dd_corp_id,value);
 	}



	public TDataEnterpriseModel(){
		super();
	...
	private void initFieldsType(){
		...
		this._fieldType.put("dd_corp_id","String");
	}
	@Override
	...
	public void fillModel(ResultSet resultSet) {
		try { 
		 ...
		 if(isExistColumn(resultSet,"dd_corp_id")){
			 this.dd_corp_id=resultSet.getString("dd_corp_id");
		}
  ...
  @Override
   public String getExist() {
	    String sql="select 1 from "+TABLE_NAME;
		    sql+=" where   enterprise_id="+Utility.getSqlFielStatement("string",this.enterprise_id)+"  ";
	    return sql;
   }
   ...
   public String getInsert() {
       String sql="insert into "+TABLE_NAME+"(enterprise_id,name,short_name,address,description,telephone_number,is_valid,create_time,last_edit_time,creation_user_id,last_edit_user_id,dd_corp_id) values("+Utility.getSqlFielStatement("string",this.enterprise_id)+","+Utility.getSqlFielStatement("string",this.name)+","+Utility.getSqlFielStatement("string",this.short_name)+","+Utility.getSqlFielStatement("string",this.address)+","+Utility.getSqlFielStatement("string",this.description)+","+Utility.getSqlFielStatement("string",this.telephone_number)+","+this.is_valid+","+Utility.getSqlFielStatement("date",this.create_time)+","+Utility.getSqlFielStatement("date",this.last_edit_time)+","+Utility.getSqlFielStatement("string",this.creation_user_id)+","+Utility.getSqlFielStatement("string",this.last_edit_user_id)+","+Utility.getSqlFielStatement("string",this.dd_corp_id)+")";
       return sql;
   }
   ...
   return sql;
	...
	public String getSelect() {
		String sql="select enterprise_id,name,short_name,address,description,telephone_number,is_valid,create_time,last_edit_time,creation_user_id,last_edit_user_id,dd_corp_id from "+TABLE_NAME;
		if(!Utility.isNullOrEmpty(enterprise_id)){
			sql+=" where  enterprise_id="+Utility.getSqlFielStatement("string",this.enterprise_id)+" ";
		}
		return sql;
	}
   ...
   public String getDelete() {
	 String sql="delete from "+TABLE_NAME+" where  enterprise_id="+Utility.getSqlFielStatement("string",this.enterprise_id)+" ";
	 return sql;
   }
