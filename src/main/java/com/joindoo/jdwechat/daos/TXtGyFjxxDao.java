...
public class TXtGyFjxxDao extends BaseDao {
	public TXtGyFjxxDao(){super();}
	public TXtGyFjxxDao(DataContext dataContext){
		super(dataContext);
	}
  ...
  @Override
	public boolean exist(BaseModel model) {
	    String sql=((TXtGyFjxxModel)model).getExist();
   ...
   public void insert(BaseModel model) {
       String sql=((TXtGyFjxxModel)model).getInsert();
  ...
  public boolean insertOnSubmit(BaseModel model) throws Exception {
	TXtGyFjxxModel bean= (TXtGyFjxxModel)model;
  ...
  public void update(BaseModel model) {
	 String sql=((TXtGyFjxxModel)model).getUpdate();
	 if(sql!=null&&sql!=""){
	 DBHelper.executeNonQuery(DataContext.getCurrentConnection(),sql);
	 }
  }
   public boolean updateOnSubmit(BaseModel model) throws Exception {
	 ...
	 if(changeFields.containsKey("fj_mc"))sb.append("fj_mc=?,");
	 if(changeFields.containsKey("fj_dx"))sb.append("fj_dx=?,");
	 if(changeFields.containsKey("fj_wz"))sb.append("fj_wz=?,");
	 if(changeFields.containsKey("fj_lj"))sb.append("fj_lj=?,");
	 if(changeFields.containsKey("sjcd_mzs"))sb.append("sjcd_mzs=?,");
	 if(changeFields.containsKey("sx_sj"))sb.append("sx_sj=?,");
	 if(changeFields.containsKey("sfyx_bj"))sb.append("sfyx_bj=?,");
	 if(changeFields.containsKey("md5"))sb.append("md5=?,");
	 if(changeFields.containsKey("lr_sj"))sb.append("lr_sj=?,");
	 if(changeFields.containsKey("lrry_xh"))sb.append("lrry_xh=?,");
	 if(changeFields.containsKey("cgsc_sj"))sb.append("cgsc_sj=?,");
	 if(changeFields.containsKey("zfj_xh"))sb.append("zfj_xh=?,");
	 ...
	 int index=1;
	 /*非主键*/
	 if(changeFields.containsKey("fj_mc")){
		 t=bean.getfj_mc();
		 if (t==null) statement.setNull(index, Types.VARCHAR);
		 else statement.setObject(index, t, Types.VARCHAR);
		 index++;
	 }
	 if(changeFields.containsKey("fj_dx")){
		 t=bean.getfj_dx();
		 if (t==null) statement.setNull(index, Types.INTEGER);
		 else statement.setObject(index, t, Types.INTEGER);
		 index++;
	 }
	 if(changeFields.containsKey("fj_wz")){
		 t=bean.getfj_wz();
		 if (t==null) statement.setNull(index, Types.VARCHAR);
		 else statement.setObject(index, t, Types.VARCHAR);
		 index++;
	 }
	 if(changeFields.containsKey("fj_lj")){
		 t=bean.getfj_lj();
		 if (t==null) statement.setNull(index, Types.VARCHAR);
		 else statement.setObject(index, t, Types.VARCHAR);
		 index++;
	 }
	 if(changeFields.containsKey("sjcd_mzs")){
		 t=bean.getsjcd_mzs();
		 if (t==null) statement.setNull(index, Types.INTEGER);
		 else statement.setObject(index, t, Types.INTEGER);
		 index++;
	 }
	 if(changeFields.containsKey("sx_sj")){
		 t=bean.getsx_sj();
		 if (t==null) statement.setNull(index, Types.TIMESTAMP);
		 else statement.setObject(index, new java.sql.Date(((java.util.Date)t).getTime()), Types.TIMESTAMP);
		 index++;
	 ...
	 if(changeFields.containsKey("md5")){
		 t=bean.getmd5();
		 if (t==null) statement.setNull(index, Types.VARCHAR);
		 else statement.setObject(index, t, Types.VARCHAR);
		 index++;
	 ...
	 if(changeFields.containsKey("cgsc_sj")){
		 t=bean.getcgsc_sj();
		 if (t==null) statement.setNull(index, Types.TIMESTAMP);
		 else statement.setObject(index, new java.sql.Date(((java.util.Date)t).getTime()), Types.TIMESTAMP);
		 index++;
	 }
	 if(changeFields.containsKey("zfj_xh")){
		 t=bean.getzfj_xh();
		 if (t==null) statement.setNull(index, Types.VARCHAR);
		 else statement.setObject(index, t, Types.VARCHAR);
		 index++;
    ...
    @Override
    public TXtGyFjxxModel find(BaseModel model) {
	 TXtGyFjxxModel tModel=(TXtGyFjxxModel)model;
   ...
   @Override
    public List<BaseModel> findAll(String condition) {
		TXtGyFjxxModel tModel=new TXtGyFjxxModel();
	...
	public void getData2ModelList(ResultSet set, List<BaseModel> resultList){
		try {
			if(null==set)return;
			while(set.next()){
 				TXtGyFjxxModel model=new TXtGyFjxxModel();
                model.fillModel(set);
	...
	public String getCountSql(String condition) {
		String sql="select count(*) as count from "+ TXtGyFjxxModel.TABLE_NAME;
		return sql;
	}
   ...
   public void delete(BaseModel model) {
	 String sql=((TXtGyFjxxModel)model).getDelete();
	 DBHelper.executeNonQuery(DataContext.getCurrentConnection(),sql);
  }
