...
public class TXtQxJsDao extends BaseDao {
	public TXtQxJsDao(){super();}
	public TXtQxJsDao(DataContext dataContext){
		super(dataContext);
	}
  ...
  @Override
	public boolean exist(BaseModel model) {
	    String sql=((TXtQxJsModel)model).getExist();
   ...
   public void insert(BaseModel model) {
       String sql=((TXtQxJsModel)model).getInsert();
  ...
  public boolean insertOnSubmit(BaseModel model) throws Exception {
	TXtQxJsModel bean= (TXtQxJsModel)model;
  ...
  public void update(BaseModel model) {
	 String sql=((TXtQxJsModel)model).getUpdate();
	 if(sql!=null&&sql!=""){
	 DBHelper.executeNonQuery(DataContext.getCurrentConnection(),sql);
	 }
  }
   public boolean updateOnSubmit(BaseModel model) throws Exception {
    ...
    @Override
    public TXtQxJsModel find(BaseModel model) {
	 TXtQxJsModel tModel=(TXtQxJsModel)model;
   ...
   @Override
    public List<BaseModel> findAll(String condition) {
		TXtQxJsModel tModel=new TXtQxJsModel();
	...
	public String getCountSql(String condition) {
		String sql="select count(*) as count from "+ TXtQxJsModel.TABLE_NAME;
		return sql;
	}
   ...
   public void delete(BaseModel model) {
	 String sql=((TXtQxJsModel)model).getDelete();
	 DBHelper.executeNonQuery(DataContext.getCurrentConnection(),sql);
  }
