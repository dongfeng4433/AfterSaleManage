...
public class TDataCustomerDao extends BaseDao {
	public TDataCustomerDao(){super();}
	public TDataCustomerDao(DataContext dataContext){
		super(dataContext);
	}
  ...
  @Override
	public boolean exist(BaseModel model) {
	    String sql=((TDataCustomerModel)model).getExist();
   ...
   public void insert(BaseModel model) {
       String sql=((TDataCustomerModel)model).getInsert();
  ...
  public boolean insertOnSubmit(BaseModel model) throws Exception {
	TDataCustomerModel bean= (TDataCustomerModel)model;
  ...
  public void update(BaseModel model) {
	 String sql=((TDataCustomerModel)model).getUpdate();
	 if(sql!=null&&sql!=""){
	 DBHelper.executeNonQuery(DataContext.getCurrentConnection(),sql);
	 }
  }
   public boolean updateOnSubmit(BaseModel model) throws Exception {
	 ...
	 if(changeFields.containsKey("type_code"))sb.append("type_code=?,");
	 ...
	 if(changeFields.containsKey("type_code")){
		 t=bean.gettype_code();
		 if (t==null) statement.setNull(index, Types.VARCHAR);
		 else statement.setObject(index, t, Types.VARCHAR);
		 index++;
    ...
    @Override
    public TDataCustomerModel find(BaseModel model) {
	 TDataCustomerModel tModel=(TDataCustomerModel)model;
   ...
   @Override
    public List<BaseModel> findAll(String condition) {
		TDataCustomerModel tModel=new TDataCustomerModel();
	...
	public String getCountSql(String condition) {
		String sql="select count(*) as count from "+ TDataCustomerModel.TABLE_NAME;
		return sql;
	}
   ...
   public void delete(BaseModel model) {
	 String sql=((TDataCustomerModel)model).getDelete();
	 DBHelper.executeNonQuery(DataContext.getCurrentConnection(),sql);
  }
