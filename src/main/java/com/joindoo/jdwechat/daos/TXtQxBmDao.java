...
public class TXtQxBmDao extends BaseDao {
	public TXtQxBmDao(){super();}
	public TXtQxBmDao(DataContext dataContext){
		super(dataContext);
	}
  ...
  @Override
	public boolean exist(BaseModel model) {
	    String sql=((TXtQxBmModel)model).getExist();
   ...
   public void insert(BaseModel model) {
       String sql=((TXtQxBmModel)model).getInsert();
  ...
  public boolean insertOnSubmit(BaseModel model) throws Exception {
	TXtQxBmModel bean= (TXtQxBmModel)model;
  ...
  public void update(BaseModel model) {
	 String sql=((TXtQxBmModel)model).getUpdate();
	 if(sql!=null&&sql!=""){
	 DBHelper.executeNonQuery(DataContext.getCurrentConnection(),sql);
	 }
  }
   public boolean updateOnSubmit(BaseModel model) throws Exception {
    ...
    @Override
    public TXtQxBmModel find(BaseModel model) {
	 TXtQxBmModel tModel=(TXtQxBmModel)model;
   ...
   @Override
    public List<BaseModel> findAll(String condition) {
		TXtQxBmModel tModel=new TXtQxBmModel();
	...
	public String getCountSql(String condition) {
		String sql="select count(*) as count from "+ TXtQxBmModel.TABLE_NAME;
		return sql;
	}
   ...
   public void delete(BaseModel model) {
	 String sql=((TXtQxBmModel)model).getDelete();
	 DBHelper.executeNonQuery(DataContext.getCurrentConnection(),sql);
  }
