...
public class TDataEnterpriseDao extends BaseDao {
	public TDataEnterpriseDao(){super();}
	public TDataEnterpriseDao(DataContext dataContext){
		super(dataContext);
	}
  ...
  @Override
	public boolean exist(BaseModel model) {
	    String sql=((TDataEnterpriseModel)model).getExist();
   ...
   public void insert(BaseModel model) {
       String sql=((TDataEnterpriseModel)model).getInsert();
  ...
  public boolean insertOnSubmit(BaseModel model) throws Exception {
	TDataEnterpriseModel bean= (TDataEnterpriseModel)model;
  ...
  public void update(BaseModel model) {
	 String sql=((TDataEnterpriseModel)model).getUpdate();
	 if(sql!=null&&sql!=""){
	 DBHelper.executeNonQuery(DataContext.getCurrentConnection(),sql);
	 }
  }
   public boolean updateOnSubmit(BaseModel model) throws Exception {
	 ...
	 if(changeFields.containsKey("short_name"))sb.append("short_name=?,");
	 if(changeFields.containsKey("address"))sb.append("address=?,");
	 if(changeFields.containsKey("description"))sb.append("description=?,");
	 if(changeFields.containsKey("telephone_number"))sb.append("telephone_number=?,");
	 ...
	 if(changeFields.containsKey("dd_corp_id"))sb.append("dd_corp_id=?,");
	 ...
	 if(changeFields.containsKey("short_name")){
		 t=bean.getshort_name();
		 if (t==null) statement.setNull(index, Types.VARCHAR);
		 else statement.setObject(index, t, Types.VARCHAR);
		 index++;
	 ...
	 if(changeFields.containsKey("telephone_number")){
		 t=bean.gettelephone_number();
		 if (t==null) statement.setNull(index, Types.VARCHAR);
		 else statement.setObject(index, t, Types.VARCHAR);
		 index++;
	 ...
	 if(changeFields.containsKey("dd_corp_id")){
		 t=bean.getdd_corp_id();
		 if (t==null) statement.setNull(index, Types.VARCHAR);
		 else statement.setObject(index, t, Types.VARCHAR);
		 index++;
    ...
    @Override
    public TDataEnterpriseModel find(BaseModel model) {
	 TDataEnterpriseModel tModel=(TDataEnterpriseModel)model;
   ...
   @Override
    public List<BaseModel> findAll(String condition) {
		TDataEnterpriseModel tModel=new TDataEnterpriseModel();
	...
	public String getCountSql(String condition) {
		String sql="select count(*) as count from "+ TDataEnterpriseModel.TABLE_NAME;
		return sql;
	}
   ...
   public void delete(BaseModel model) {
	 String sql=((TDataEnterpriseModel)model).getDelete();
	 DBHelper.executeNonQuery(DataContext.getCurrentConnection(),sql);
  }
