...
public class TDataNotificationDao extends BaseDao {
	public TDataNotificationDao(){super();}
	public TDataNotificationDao(DataContext dataContext){
		super(dataContext);
	}
  ...
  @Override
	public boolean exist(BaseModel model) {
	    String sql=((TDataNotificationModel)model).getExist();
   ...
   public void insert(BaseModel model) {
       String sql=((TDataNotificationModel)model).getInsert();
  ...
  public boolean insertOnSubmit(BaseModel model) throws Exception {
	TDataNotificationModel bean= (TDataNotificationModel)model;
	 ...
	 t=bean.getaccept_user_id();
	 if (t==null) statement.setNull(index, Types.VARCHAR);
	 else statement.setObject(index, t, Types.VARCHAR);
	 index++;

	 t=bean.getthird_user_id();
	 if (t==null) statement.setNull(index, Types.VARCHAR);
	 else statement.setObject(index, t, Types.VARCHAR);
	 index++;
	 ...
	 t=bean.getmsg_status();
	 if (t==null) statement.setNull(index, Types.VARCHAR);
	 else statement.setObject(index, t, Types.VARCHAR);
	 index++;

	 t=bean.getattempt_times();
	 if (t==null) statement.setNull(index, Types.INTEGER);
	 else statement.setObject(index, t, Types.INTEGER);
	 index++;
  ...
  public void update(BaseModel model) {
	 String sql=((TDataNotificationModel)model).getUpdate();
	 if(sql!=null&&sql!=""){
	 DBHelper.executeNonQuery(DataContext.getCurrentConnection(),sql);
	 }
  }
   public boolean updateOnSubmit(BaseModel model) throws Exception {
	 ...
	 if(changeFields.containsKey("accept_user_id"))sb.append("accept_user_id=?,");
	 if(changeFields.containsKey("third_user_id"))sb.append("third_user_id=?,");
	 if(changeFields.containsKey("title"))sb.append("title=?,");
	 ...
	 if(changeFields.containsKey("send_time"))sb.append("send_time=?,");
	 if(changeFields.containsKey("msg_status"))sb.append("msg_status=?,");
	 if(changeFields.containsKey("attempt_times"))sb.append("attempt_times=?,");
	 ...
	 if(changeFields.containsKey("accept_user_id")){
		 t=bean.getaccept_user_id();
		 if (t==null) statement.setNull(index, Types.VARCHAR);
		 else statement.setObject(index, t, Types.VARCHAR);
		 index++;
	 }
	 if(changeFields.containsKey("third_user_id")){
		 t=bean.getthird_user_id();
		 if (t==null) statement.setNull(index, Types.VARCHAR);
		 else statement.setObject(index, t, Types.VARCHAR);
		 index++;
	 }
	 if(changeFields.containsKey("title")){
		 t=bean.gettitle();
		 if (t==null) statement.setNull(index, Types.VARCHAR);
		 else statement.setObject(index, t, Types.VARCHAR);
		 index++;
	 ...
	 if(changeFields.containsKey("send_time")){
		 t=bean.getsend_time();
		 if (t==null) statement.setNull(index, Types.TIMESTAMP);
		 else statement.setObject(index, new java.sql.Date(((java.util.Date)t).getTime()), Types.TIMESTAMP);
		 index++;
	 }
	 if(changeFields.containsKey("msg_status")){
		 t=bean.getmsg_status();
		 if (t==null) statement.setNull(index, Types.VARCHAR);
		 else statement.setObject(index, t, Types.VARCHAR);
		 index++;
	 }
	 if(changeFields.containsKey("attempt_times")){
		 t=bean.getattempt_times();
		 if (t==null) statement.setNull(index, Types.INTEGER);
		 else statement.setObject(index, t, Types.INTEGER);
		 index++;
    ...
    @Override
    public TDataNotificationModel find(BaseModel model) {
	 TDataNotificationModel tModel=(TDataNotificationModel)model;
   ...
   @Override
    public List<BaseModel> findAll(String condition) {
		TDataNotificationModel tModel=new TDataNotificationModel();
	...
	public void getData2ModelList(ResultSet set, List<BaseModel> resultList){
		try {
			if(null==set)return;
			while(set.next()){
 				TDataNotificationModel model=new TDataNotificationModel();
                model.fillModel(set);
	...
	public String getCountSql(String condition) {
		String sql="select count(*) as count from "+ TDataNotificationModel.TABLE_NAME;
		return sql;
	}
   ...
   public void delete(BaseModel model) {
	 String sql=((TDataNotificationModel)model).getDelete();
	 DBHelper.executeNonQuery(DataContext.getCurrentConnection(),sql);
  }
