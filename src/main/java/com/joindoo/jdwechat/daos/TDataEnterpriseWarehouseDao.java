...
public class TDataEnterpriseWarehouseDao extends BaseDao {
	public TDataEnterpriseWarehouseDao(){super();}
	public TDataEnterpriseWarehouseDao(DataContext dataContext){
		super(dataContext);
	}
  ...
  @Override
	public boolean exist(BaseModel model) {
	    String sql=((TDataEnterpriseWarehouseModel)model).getExist();
   ...
   public void insert(BaseModel model) {
       String sql=((TDataEnterpriseWarehouseModel)model).getInsert();
  ...
  public boolean insertOnSubmit(BaseModel model) throws Exception {
	TDataEnterpriseWarehouseModel bean= (TDataEnterpriseWarehouseModel)model;
  ...
  public void update(BaseModel model) {
	 String sql=((TDataEnterpriseWarehouseModel)model).getUpdate();
	 if(sql!=null&&sql!=""){
	 DBHelper.executeNonQuery(DataContext.getCurrentConnection(),sql);
	 }
  }
   public boolean updateOnSubmit(BaseModel model) throws Exception {
    ...
    @Override
    public TDataEnterpriseWarehouseModel find(BaseModel model) {
	 TDataEnterpriseWarehouseModel tModel=(TDataEnterpriseWarehouseModel)model;
   ...
   @Override
    public List<BaseModel> findAll(String condition) {
		TDataEnterpriseWarehouseModel tModel=new TDataEnterpriseWarehouseModel();
	...
	public String getCountSql(String condition) {
		String sql="select count(*) as count from "+ TDataEnterpriseWarehouseModel.TABLE_NAME;
		return sql;
	}
   ...
   public void delete(BaseModel model) {
	 String sql=((TDataEnterpriseWarehouseModel)model).getDelete();
	 DBHelper.executeNonQuery(DataContext.getCurrentConnection(),sql);
  }
